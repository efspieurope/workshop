...
Link to `r paste("[draft program (status: 17th April 2024)](", past[past[, "Year"] == last + 1, "Program"], ")", sep = "")`  and `r paste("[registration](", reg[reg[, "Year"] == last + 1, "Registration"], ")", sep = "")`.
...
So far, Roche and Novartis have a comprehensive block booking agreement with the workshop, i.e. all colleagues working at these companies do not need to pay a registration fee for face-to-face or virtual participation.

# My company (so far Roche and Novartis) has a block booking for face-to-face AND virtual participation. How do I register?
