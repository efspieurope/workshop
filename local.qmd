...
The local execution team (LET) takes care of the event organisation on site in Basel.

# 2026

The members of the LET in 2026 are:

```{r, include=TRUE, echo=FALSE}
sci26[, "email"] <- mailmerge(paste(sci26[, "First"], " ", sci26[, "Last"], sep = ""), sci26[, "E-mail"])
kable(filter(sci26, LET == 1)[, c("First", "Last", "Type", "Affiliation", "email")], align = "ll")
```

# 2025

The members of the LET in 2025 were:

```{r, include=TRUE, echo=FALSE}
kable(filter(sci25, Local == 1)[, c("First", "Last", "Type", "Affiliation")], align = "ll")
```

# 2024

The members of the LET in 2024 were:
...
The members of the LET in 2023 were:
...
The members of the LET in 2022 were:

```{r, include=TRUE, echo=FALSE}
kable(select(filter(sci22, Local == 1), -Local, -SciCom, -email, -Gender, -OrgCom), align = "llccl")
```
