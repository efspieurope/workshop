...
For 2024, Novo Nordisk and Bayer have a a block booking for virtual participation, i.e. all colleagues working at Novo Nordisk or Bayer do not need to pay a registration fee for virtual participation. Face-to-face registration fee remains the same.
...
# My company (Novo Nordisk, Bayer) has a block booking for virtual participation only. How do I register?
...
# My company (Novo Nordisk, Bayer) has a block booking for virtual attendance only. I still want to attend face-to-face. How much do I need to pay?
