...
sci26 <- arrange(filter(sci26, SC == 1), Gender, Last)
```
...
```{r, include=TRUE, echo=FALSE}
kable(select(sci23, -Local, -SciCom, -email, -OrgCom), align = "llccl")
```
...
```{r, include=TRUE, echo=FALSE}
kable(select(sci22, -Local, -SciCom, -email, -OrgCom), align = "llccl")
```
