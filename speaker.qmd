---
title: "Frequently asked questions for contributors (Speakers, Panelists, Chairs)"
date: last-modified
output: 
...
Even if you have been invited, all speakers, panelists and chairs are kindly requested to register themselves. For registration, please `r res["registration"]`.

# Reimbursement

See [here](reimbursement.html).

# Regulatory dinner

On Tuesday night a (self-paid) dinner for regulators and HTA assessors is organized by Benjamin Hofner and Heidi Mestl in a restaurant in Basel. Regulators and HTA assessors who are interested to join can register using [this form](https://forms.gle/ihANxp8V3gUctCMu6). Under this link you also find more information about the event.

# Hotels

We ask you to book your travel and accommodation yourself. 
