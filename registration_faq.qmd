...
All colleagues working at Roche companies do not need to pay a registration fee for face-to-face or virtual participation. You simply register via `r inputData(regtext = "this form")["registration"]` and indicate face-to-face or virtual attendance. You do not need to pay a registration fee, this is covered by your company via the block booking.
...
Block booking for face-to-face participation. If you wish to take advantage of this block booking please contact [Julie Jones](mailto:julie.jones@novartis.com).
