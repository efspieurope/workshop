...
source(paste(path, "/functions/inputProg.r", sep = ""))
res <- inputProg()
...
- Block booking for face-to-face attendance: 
  ...
  - Beyond 91 face-to-face participants per company we charge 12500 + 100 Euro per each additional participant. 
...
These companies have a block booking for face-to-face and virtual attendance. You simply register via `r inputProg(regtext = "this form")["registration"]` and indicate face-to-face or virtual attendance. You do not need to pay a registration fee, this is covered by your company via the block booking.
...
You simply register via `r inputProg(regtext = "this form")["registration"]` and indicate virtual attendance. You do not need to pay a registration fee, this is covered by your company via a block booking.
