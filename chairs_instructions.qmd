---
title: "Session chairs: instructions"
date: last-modified
output: 
...
You have agreed to contribute to the `r res["program_workshop"]` as a session chair. Many thanks for that!

# Scope and contact

This document provides necessary information for session chairs. For any further questions please do not hesitate to reach out to one of the [local organizing committee members](local.html).
