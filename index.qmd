...
Since its inception in 2016 the workshop has always taken place in Basel, Switzerland. Details about the `r inputProg()["year"]` issue are available [here](next.html).
...
[ASA workshop](https://ww2.amstat.org/meetings/risw/2025/workshopinfo.cfm)
