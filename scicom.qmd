...
sci26 <- dplyr::filter(sci26, (is.na(Committee) == FALSE) & (Committee %in% c("SC", "SC + OC")))
sci26 <- arrange(sci26, desc(Committee), Gender, Last)
```
...
kable(select(sci26, First, Last, Gender, Type, Affiliation), align = "llccl", col.names = c("First", "Last", "Gender", "Type", "Affiliation"))
```
