...
You have registered for face-to-face participation to the `r paste("[EFSPI regulatory statistics workshop ", current, "](", past[past[, "Year"] == current, "Program"], ")", sep = "")` as a Roche or Novartis colleagues with statistics background. 
...
- Identify your industry session chair from the `r paste("[program](", past[past[, "Year"] == current, "Program"], ")", sep = "")` and make yourself known to her/him ahead of the session.
